<nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <span style="color: green; font-weight: bold;"><?php echo $_settings->info('name') ?></span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="./" style="color: white">Home</a></li>
                        <?php 
                        ...
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" id="navbarDropdown<?php echo $crow['id'] ?>" href="#" role="button" data-toggle="dropdown" aria-expanded="false" style="color:white;"><?php echo $crow['category'] ?></a></a>
                        ...
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link" href="./?p=about" style="color: white">About Us</a></li>
                    </ul>
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        ...
                        <li class="nav-item dropdown" style="display: inline-block; list-style: none;">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-toggle="dropdown" aria-expanded="false" style="color:white; text-decoration:none;">Hi, <?php echo $_settings->userdata('firstname')?>!</a>
                        <ul class="dropdown-menu p-0" aria-labelledby="navbarDropdown">
                          <li><a class="dropdown-item" href="./?p=my_account" style="text-decoration:none;">My Account</a></li>
                           <li><a class="dropdown-item" href="logout.php" style="text-decoration:none;">Logout</a></li>
                          </ul>
                        </li>
